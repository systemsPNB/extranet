    ...
    if($_SESSION['nivel']==1){
        ...
        class PDF extends FPDF{
            ...
            function Header(){
                ...
                $this->Image('views/img/ministerio.png',10,20,20);
                // Arial bold 20
                $this->SetFont('Arial', 'I', 10);
                // $this->Ln();
                // $this->SetX(40);
                $this->Cell(180, 4, 'REPÚBLICA BOLIVARIANA DE VENEZUELA', 1, 1, 'C');

                $this->Cell(210, 4, 'MINISTERIO DEL PODER POPULAR PARA RELACIONES INTERIORES, JUSTICIA Y PAZ
                ', 1, 1, 'C');

                $this->Cell(180, 4, 'CUERPO DE POLICÍA NACIONAL BOLIVARIANA', 1, 1, 'C');
                $this->Cell(180, 4, 'OFICINA DE RECURSOS HUMANOS', 1, 1, 'C');
                // $this->SetX(40);
                // $this->Cell(85, 4, 'CUERPO DE POLICÍA NACIONAL BOLIVARIANA', 0, 0, 'L');
                $this->Image('views/img/pnb.jpg',180,15,20);
